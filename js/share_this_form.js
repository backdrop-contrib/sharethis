...
(function ($) {
  ...
  window.backdrop_st = {
    ...
    setupServiceText: function () {
      ...
      stlib_picker.setupPicker(picker, service, backdrop_st.serviceCallback);
    ...
    getGlobalCNSConfig: function () {
      try {
        backdrop_st.odjs(document.location.protocol === 'https:' ? 'https://wd-edge.sharethis.com/button/getDefault.esi?cb=backdrop_st.cnsCallback' : 'http://wd-edge.sharethis.com/button/getDefault.esi?cb=backdrop_st.cnsCallback');
      }
      catch (err) {
